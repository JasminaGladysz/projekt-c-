#include <fmx.h>    //obs³uga komponentów
...
//CHECKBOZY NA OKAZJE
	...
	sezonFilter = 0; // Startowa wartoœæ filtrowania na 15 (wszystkie sezony)
	okazjaFilter = 0; // Startowa wartoœæ filtrowania na 15 (wszystkie okazje)
